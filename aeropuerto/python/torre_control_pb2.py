...
_HELLOREQUEST = _descriptor.Descriptor(
  name='HelloRequest',
  full_name='torreDeControl.HelloRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='torreDeControl.HelloRequest.name', index=0,
...
_HELLOREPLY = _descriptor.Descriptor(
  name='HelloReply',
  full_name='torreDeControl.HelloReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='torreDeControl.HelloReply.message', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
HelloRequest = _reflection.GeneratedProtocolMessageType('HelloRequest', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:torreDeControl.HelloRequest)
  ))
...
HelloReply = _reflection.GeneratedProtocolMessageType('HelloReply', (_message.Message,), dict(
  ...
  __module__ = 'torre_control_pb2'
  # @@protoc_insertion_point(class_scope:torreDeControl.HelloReply)
  ))
...
_CONTROL = _descriptor.ServiceDescriptor(
  name='Control',
  full_name='torreDeControl.Control',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='SayHello',
    full_name='torreDeControl.Control.SayHello',
    index=0,
